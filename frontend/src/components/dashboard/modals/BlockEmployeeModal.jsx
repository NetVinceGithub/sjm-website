    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-red-50 p-3 border-t-4 border-red-500 rounded-lg shadow-2xl w-11/12 sm:w-96 md:w-[28rem] lg:w-[30rem] relative">
        ...
        <div className="mt-4 flex justify-center gap-2">
          <button
            onClick={onClose}
            className="flex-1  text-xs px-4 py-2 h-8 border flex justify-center items-center text-center text-neutralDGray rounded-lg hover:bg-red-400 hover:text-white transition-all"
          >
            Cancel
          </button>
          <button
